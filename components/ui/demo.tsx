  ...
  return (
    ...
    >
      ...
      <g fillOpacity={1} fillRule="nonzero" stroke="none">
        <path
          d="M155.876 378.285l-23.048 9.873h-14.376v4.027h-7.201v27.07h89.24v-27.07h-7.198v-4.027h-14.37/ -23.047-9.873z"
          fill="#004990"
...
function OpenAIItem(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="256"
...
const allLogos = [
  ...
  { name: "OpenAI", id: 14, img: OpenAIItem },
];
